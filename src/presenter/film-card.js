...
export default class FilmCard {
  constructor(
    ...
    this._handleAddWatchlisPopupClick =
      this._handleAddWatchlisPopupClick.bind(this);
  ...
  init(film) {
    ...
    this._filmCardComponent.setAddWatchlisClickHandler(
      this._handleAddWatchlisClick
    );
    this._filmCardComponent.setWatchedClickHandler(this._handleWatchedClick);
    this._filmCardComponent.setFavoriteClickHandler(this._handleFavoriteClick);

    this._popupComponent.setAddWatchlisClickHandler(
      this._handleAddWatchlisPopupClick
    );
    this._popupComponent.setWatchedClickHandler(this._handleWatchedPopupClick);
    this._popupComponent.setFavoriteClickHandler(
      this._handleFavoritePopupClick
    );
  ...
  _handleWatchedClick() {
    ...
    this._changeData(UserAction.UPDATE_FILM, UpdateType.MINOR, updatedMovie);
  }
  ...
  _handleModelEvent(userAction, updateType, update) {
    switch (userAction) {
      case UserAction.ADD_COMMENT: {
        this._api
          .addComment(this._film.id, update)
          .then((response) => {
